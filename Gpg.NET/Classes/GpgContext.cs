...
namespace Gpg.NET
{
    ...
    public class GpgContext : IDisposable
	{
        ...
        /// <summary>
        /// Пытается расшифровать содержимое буфера данных.
        ...
        /// <summary>
        /// Пытается зашифровать содержимое буфера данных для данного получателя.
        /// </summary>
        ...
        /// <summary>
        /// Пытается зашифровать содержимое буфера данных для нескольких получателей.
        /// </summary>
        /// <param name="plain">Буфер данных, содержащий данные открытого текста, подлежащие шифрованию.</param>
